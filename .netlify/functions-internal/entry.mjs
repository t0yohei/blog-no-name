...
import { A as App, s as server_default, i as deserializeManifest } from './chunks/astro.4c29b78c.mjs';
import { defineComponent, h as h$2, createSSRApp } from 'vue';
import { renderToString } from 'vue/server-renderer';
import { _ as _page0, a as _page1 } from './chunks/pages/all.3026cc68.mjs';
...
const StaticHtml = defineComponent({
	...
	setup({ name, value }) {
		...
		return () => h$2('astro-slot', { name, innerHTML: value });
	},
});
...
const pageMap = new Map([["src/pages/index.astro", _page0],["src/pages/about.astro", _page1],]);
const renderers = [Object.assign({"name":"astro:jsx","serverEntrypoint":"astro/jsx/server.js","jsxImportSource":"astro"}, { ssr: server_default }),Object.assign({"name":"@astrojs/vue","clientEntrypoint":"@astrojs/vue/client.js","serverEntrypoint":"@astrojs/vue/server.js"}, { ssr: _renderer1 }),];

const _manifest = Object.assign(deserializeManifest({"adapterName":"@astrojs/netlify/functions","routes":[{"file":"","links":["_astro/Header.astro_astro_type_style_index_0_lang.70dd3b15.css","_astro/about.82222232.css","_astro/global.475eecb7.css","_astro/index.ad581e7c.css"],"scripts":[],"routeData":{"route":"/","type":"page","pattern":"^\\/$","segments":[],"params":[],"component":"src/pages/index.astro","pathname":"/","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":["_astro/global.475eecb7.css","_astro/Header.astro_astro_type_style_index_0_lang.70dd3b15.css","_astro/about.82222232.css"],"scripts":[{"type":"inline","value":"const t=\"t0yohei\",i=`\n  <div class=\"main\">\n    <div class=\"main-top\">\n      <a href=\"https://twitter.com/${t}\">\n        <img\n          class=\"twitter-image\"\n          src=\"https://pbs.twimg.com/profile_images/731737341488816130/wH_caJBf_400x400.jpg\"\n        />\n      </a>\n      <div class=\"top\">\n        <h1><span>とよへい</span></h1>\n        <p>Software Engineer</p>\n      </div>\n    </div>\n    <p class=\"description\">しがないソフトウェアエンジニャです。</p>\n    <table class=\"profile-table\">\n      <tbody>\n        <tr>\n          <th class=\"show\">好きな言語 / FW</th>\n          <td class=\"show\"><p>Ruby, Rails, Vue.js</p></td>\n        </tr>\n        <tr>\n          <th class=\"show\">好きな物</th>\n          <td class=\"show\"><p>アニメ、コーヒー</p></td>\n        </tr>\n        <tr>\n          <th class=\"show\">住処</th>\n          <td class=\"show\"><p>東京周辺</p></td>\n        </tr>\n        <tr>\n          <th class=\"show\">SNS</th>\n          <td class=\"show\">\n            <a href=\"https://twitter.com/${t}\"><img src=\"/img/twitter.svg\" alt=\"twitter icon\" /></a>\n            <a href=\"https://github.com/${t}\"><img src=\"/img/github.svg\" alt=\"github icon\" /></a>\n            <a href=\"https://qiita.com/${t}\"><img src=\"/img/qiita.png\" alt=\"qiita icon\" class=\"sns-icon\" /></a>\n          </td>\n        </tr>\n      </tbody>\n    </table>\n  </div>\n\n  <style>\n  .main {\n    margin-top: 20px;\n  }\n\n  .main-top {\n    display: flex;\n    align-items: center;\n    gap: 50px;\n  }\n\n  .twitter-image {\n    width: 150px;\n    height: 150px;\n    border-radius: 100px;\n  }\n\n  .description {\n    margin: 30px 0;\n    font-size: 18px;\n  }\n\n  .profile-table {\n    table-layout: auto;\n    width: 100%;\n    text-align: left;\n  }\n\n  .sns-icon {\n    width: 43px;\n    height: 43px;\n    margin: 2px\n  }\n  </style>\n`;class e extends HTMLElement{constructor(){super()}connectedCallback(){this.attachShadow({mode:\"open\"});const s=document.createElement(\"template\");s.innerHTML=i,this.shadowRoot.append(s.content)}}customElements.define(\"about-me\",e);\n"}],"routeData":{"route":"/about","type":"page","pattern":"^\\/about\\/?$","segments":[[{"content":"about","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/about.astro","pathname":"/about","_meta":{"trailingSlash":"ignore"}}}],"base":"/","markdown":{"drafts":false,"syntaxHighlight":"shiki","shikiConfig":{"langs":[],"theme":"github-dark","wrap":false},"remarkPlugins":[],"rehypePlugins":[],"remarkRehype":{},"gfm":true,"smartypants":true,"contentDir":"file:///Users/kyohei_toyoda/repos/src/github.com/t0yohei/blog-no-name/src/content/"},"pageMap":null,"renderers":[],"entryModules":{"\u0000@astrojs-ssr-virtual-entry":"_@astrojs-ssr-virtual-entry.mjs","/Users/kyohei_toyoda/repos/src/github.com/t0yohei/blog-no-name/src/content/blog/20230103_new_year.md?astroContent=true":"chunks/20230103_new_year.755dd5f4.mjs","/Users/kyohei_toyoda/repos/src/github.com/t0yohei/blog-no-name/src/content/blog/20230104_start_working.md?astroContent=true":"chunks/20230104_start_working.f3bb80aa.mjs","/Users/kyohei_toyoda/repos/src/github.com/t0yohei/blog-no-name/src/content/blog/20230108_add_webcomponents.md?astroContent=true":"chunks/20230108_add_webcomponents.83e29a93.mjs","/Users/kyohei_toyoda/repos/src/github.com/t0yohei/blog-no-name/src/content/blog/20230108_small_update.md?astroContent=true":"chunks/20230108_small_update.b11b50aa.mjs","/Users/kyohei_toyoda/repos/src/github.com/t0yohei/blog-no-name/src/content/blog/20230119.md?astroContent=true":"chunks/20230119.f0ab935e.mjs","/Users/kyohei_toyoda/repos/src/github.com/t0yohei/blog-no-name/src/content/blog/20230103_new_year.md?astroAssetSsr=true":"chunks/20230103_new_year.2fe4d5d2.mjs","/Users/kyohei_toyoda/repos/src/github.com/t0yohei/blog-no-name/src/content/blog/20230104_start_working.md?astroAssetSsr=true":"chunks/20230104_start_working.d99c2b44.mjs","/Users/kyohei_toyoda/repos/src/github.com/t0yohei/blog-no-name/src/content/blog/20230108_add_webcomponents.md?astroAssetSsr=true":"chunks/20230108_add_webcomponents.bfec66b2.mjs","/Users/kyohei_toyoda/repos/src/github.com/t0yohei/blog-no-name/src/content/blog/20230108_small_update.md?astroAssetSsr=true":"chunks/20230108_small_update.f0ae6399.mjs","/Users/kyohei_toyoda/repos/src/github.com/t0yohei/blog-no-name/src/content/blog/20230119.md?astroAssetSsr=true":"chunks/20230119.b6c3a882.mjs","/astro/hoisted.js?q=0":"_astro/hoisted.efc48278.js","@astrojs/vue/client.js":"_astro/client.8312f149.js","astro:scripts/before-hydration.js":""},"assets":["/_astro/Header.astro_astro_type_style_index_0_lang.70dd3b15.css","/_astro/MarkdownPostLayout.astro_astro_type_style_index_0_lang.1a87fd40.css","/_astro/about.82222232.css","/_astro/global.475eecb7.css","/_astro/index.ad581e7c.css","/_astro/client.8312f149.js","/img/blog-no-name.png","/img/favicon.svg","/img/github.svg","/img/qiita.png","/img/twitter.svg"]}), {
	pageMap: pageMap,
	renderers: renderers
});
const _args = {};
